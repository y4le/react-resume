...
export default Object.freeze({
  ...
  bookToJSX: function (book) {
    const finishDate = new Date(book.date)
  ...
  bookComparator: function (a, b, ordering) {
    const dateOrd = new Date(a.date).getTime() < new Date(b.date).getTime() ? 1 : -1
  ...
  // Skill related stuff
  SKILLS: [
    { name: 'Ruby', skill: 0.7, category: 'backend' },
    { name: 'Java', skill: 0.9, category: 'backend' },
    { name: 'Kotlin', skill: 0.2, category: 'backend' },
    { name: 'Python', skill: 0.9, category: 'backend' },
    { name: 'Tensorflow', skill: 0.5, category: 'ml' },
    { name: 'Spark', skill: 0.6, category: 'ml' },
    { name: 'CSS', skill: 0.8, category: 'web' },
    { name: 'HTML', skill: 0.8, category: 'web' },
    { name: 'Javascript', skill: 0.9, category: 'web' },
    { name: 'Bash', skill: 0.5, category: 'script' },
    { name: 'SQL', skill: 0.7, category: 'backend' },
    { name: 'Matlab', skill: 0.3, category: 'math' },
    { name: 'Mathematica', skill: 0.5, category: 'math' },
    { name: 'Photoshop', skill: 0.6, category: 'adobe' }
  ],
  skillOrderings: [
    'category',
    'experience',
